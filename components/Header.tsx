      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-18 items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="p-2 bg-green-50 rounded-sm border border-green-100">
            ...
            <div className="space-y-1 pb-3 pt-2">
              {navigationItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="block rounded-sm px-3 py-2 text-sm sm:text-base font-medium text-gray-700 hover:bg-green-50 hover:text-green-800"
