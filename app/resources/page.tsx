  ...
  const publications = [
    {
      ...
      venue: "Accepted for publication in IEEE International Conference on Computer Vision (ICCV) Workshop",
      year: "2025",
    ...
    },
    {
      ...
      links: {
        ...
        dataset: "https://huggingface.co/datasets/baselab/controlled-diet-methane-dataset"
      }
    },
    {
      id: 1,
    ...
    <div className="flex flex-col">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4">Datasets</h2>
              <p className="text-sm sm:text-base lg:text-lg text-gray-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {datasets.map((dataset) => (
                <Card key={dataset.id} className="h-full border-l-4 border-blue-400">
                  <CardHeader>
                    <div className="flex items-start justify-between mb-4">
                      <Database className="h-10 w-10 text-blue-600" />
                      <Badge 
                        variant={dataset.status === "Available" ? "default" : "secondary"}
                        className={dataset.status === "Available" ? "bg-green-600 text-white" : "bg-red-100 text-red-700 border-red-200"}
                      >
                        {dataset.status}
                      </Badge>
                    </div>
                    <CardTitle className="text-lg sm:text-xl font-bold mb-3">{dataset.title}</CardTitle>
                    <CardDescription className="text-base text-gray-600 leading-relaxed">{dataset.description}</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    {/* Key Information */}
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <span className="text-sm font-semibold text-gray-700 block">Dataset Size</span>
                        <p className="text-base text-gray-900 font-medium">{dataset.size}</p>
                      </div>
                      <div>
                        <span className="text-sm font-semibold text-gray-700 block">License</span>
                        <p className="text-base text-gray-900 font-medium">{dataset.license}</p>
                      </div>
                    </div>

                    {/* Format Information */}
                    <div>
                      <span className="text-sm font-semibold text-gray-700 block mb-1">Data Format</span>
                      <p className="text-sm text-gray-600">{dataset.format}</p>
                    </div>

                    {/* Technical Details - Collapsible or abbreviated */}
                    <div>
                      <span className="text-sm font-semibold text-gray-700 block mb-1">Technical Details</span>
                      <p className="text-sm text-gray-600 line-clamp-2">{dataset.specifications}</p>
                    </div>
                      ...
                      {dataset.status === "Available" ? (
                        <div className="flex gap-2">
                          <Button size="sm" className="w-full" asChild>
                            <a href="https://huggingface.co/datasets/baselab/controlled-diet-methane-dataset" target="_blank" rel="noopener noreferrer">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {codeRepositories.map((repo) => (
                <Card key={repo.id} className="h-full border-l-4 border-blue-400">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-3">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-white p-4 rounded-sm border">
                    ...
                    <div className="bg-gray-50 p-3 rounded-sm text-sm font-mono text-gray-700 overflow-x-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="text-center p-6 bg-white rounded-sm border border-gray-200 hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900 mb-3">Research Team</h3>
                <p className="text-sm text-gray-600 mb-4">Learn more about our researchers and their expertise</p>
              ...
              <div className="text-center p-6 bg-white rounded-sm border border-gray-200 hover:shadow-md transition-shadow">
                <h3 className="font-semibold text-gray-900 mb-3">Contact PI</h3>
                <p className="text-sm text-gray-600 mb-4">Get in touch with our Principal Investigator</p>
            ...
            <div className="text-center mt-8 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-500">USDA National Institute of Food and Agriculture Award #2022-70001-37404</p>
              <p className="text-sm text-gray-500">Southern Illinois University Carbondale</p>
            </div>
          </div>
        </div>
      </section>
