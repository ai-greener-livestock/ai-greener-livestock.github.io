            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
                  ...
                  <div className="text-center lg:text-left">
                    <div className="text-3xl font-bold text-green-700">26,000+</div>
                    <div className="text-sm text-gray-600">Images Analyzed</div>
                    <div className="text-xs text-gray-500 mt-1">Across in vitro & in vivo studies</div>
                  </div>
                  <div className="text-center lg:text-left">
              ...
              <div className="relative">
                <div className="relative overflow-hidden rounded-lg shadow-2xl">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                    <p className="text-white text-sm font-medium">
                      Live cattle methane detection using advanced optical gas imaging technology
                    </p>
                    <p className="text-white/80 text-xs mt-1">
                      FLIR Gx320 camera capturing real-time emissions for AI analysis
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute -top-4 -right-4 bg-blue-600 text-white px-3 py-2 rounded-lg shadow-lg">
                  <div className="text-sm font-semibold">In Vivo Study</div>
                  <div className="text-xs opacity-90">208K+ frames analyzed</div>
                </div>
              </div>
            </div>
          </div>
