  ...
  return (
    <div className="flex flex-col">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "AI Greener Livestock",
            "description": "USDA-funded research project developing AI-powered solutions to monitor and reduce methane emissions from livestock using optical gas imaging technology",
            "url": "https://ai-greener-livestock.github.io",
            "sameAs": [
              "https://ai-greener-livestock.github.io/research",
              "https://ai-greener-livestock.github.io/team"
            ],
            "funding": {
              "@type": "Grant",
              "funder": {
            ...
            "author": [
              {
                ...
                "jobTitle": "Associate Professor & Graduate Program Director",
                "affiliation": {
                  "@type": "Organization",
                  "name": "School of Computing, Southern Illinois University Carbondale"
                }
              },
              {
                "@type": "Person", 
                ...
                "affiliation": {
                  "@type": "Organization",
                  "name": "School of Agricultural Sciences, Southern Illinois University Carbondale"
                }
              },
              {
                "@type": "Person",
                "name": "Dr. Mohamed G. Embaby",
                "email": "membaby@ucdavis.edu",
              ...
              },
              {
                ...
                "jobTitle": "PhD Student, Graduate Research Assistant",
                "affiliation": {
                  "@type": "Organization",
                  "name": "School of Computing, Southern Illinois University Carbondale"
                }
            ...
            "keywords": ["artificial intelligence", "livestock", "methane emissions", "optical gas imaging", "computer vision", "sustainability", "agricultural AI", "climate smart agriculture"],
            "datePublished": "2024",
            "inLanguage": "en-US"
          })
        }}
      ...
      <nav className="fixed top-20 right-8 z-50 hidden lg:block">
        <div className="bg-white/90 backdrop-blur-md border rounded-sm p-2 shadow-lg">
          <div className="flex flex-col space-y-1">
            <a href="#hero" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Overview</a>
            <a href="#challenge" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Challenge</a>
            <a href="#solution" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Solution</a>
            <a href="#achievements" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Achievements</a>
            <a href="#journey" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Journey</a>
            <a href="#impact" className="text-xs sm:text-sm px-3 py-1 rounded-sm hover:bg-gray-100 transition-colors">Impact</a>
          </div>
        </div>
      </nav>
                    ...
                    <div className="relative rounded-xl overflow-hidden shadow-lg">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        <div className="text-white">
                          <h4 className="text-sm sm:text-base lg:text-lg font-semibold mb-1">Real-World Research Environment</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
              <Card className="text-center border-2 border-green-200 bg-green-50">
                <CardContent className="p-6">
                  <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-700 mb-2">88.56%</div>
                  <div className="text-sm font-medium text-green-800">Laboratory Validation</div>
                  <div className="text-xs sm:text-sm text-green-600 mt-1">Detection Accuracy</div>
                </CardContent>
              </Card>
              <Card className="text-center border-2 border-blue-200 bg-blue-50">
                <CardContent className="p-6">
                  <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-700 mb-2">74.47%</div>
                  <div className="text-sm font-medium text-blue-800">Real-World Livestock</div>
                  <div className="text-xs sm:text-sm text-blue-600 mt-1">Performance</div>
                </CardContent>
              </Card>
              <Card className="text-center border-2 border-purple-200 bg-purple-50">
                <CardContent className="p-6">
                  <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-700 mb-2">16,000+</div>
                  <div className="text-sm font-medium text-purple-800">Annotated Images</div>
                  <div className="text-xs sm:text-sm text-purple-600 mt-1">Largest Dataset</div>
                </CardContent>
              </Card>
              <Card className="text-center border-2 border-amber-200 bg-amber-50">
                <CardContent className="p-6">
                  <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-amber-700 mb-2">98%</div>
                  <div className="text-sm font-medium text-amber-800">Emission Reduction</div>
                  <div className="text-xs sm:text-sm text-amber-600 mt-1">Dietary Interventions</div>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section id="challenge" className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">The Challenge We&apos;re Solving</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-6">
                <Card className="border-l-4 border-red-500 bg-red-50">
                  <CardContent className="p-6">
                    <h3 className="text-lg sm:text-xl font-semibold text-red-800 mb-4">The Methane Problem</h3>
                ...
                <Card className="border-l-4 border-amber-500 bg-amber-50">
                  <CardContent className="p-6">
                    <h3 className="text-lg sm:text-xl font-semibold text-amber-800 mb-4">Current Limitations</h3>
                    <ul className="space-y-3 text-sm sm:text-base text-gray-700">
                      <li className="flex items-start">
              ...
              <div className="lg:pl-8">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 h-full">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-6">Critical Gap</h3>
                  <div className="space-y-4 text-sm sm:text-base text-gray-700">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="text-sm sm:text-base lg:text-lg font-medium text-green-800">
            ...
            <Tabs defaultValue="ai" className="w-full">
              <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 mb-8">
                <TabsTrigger value="ai" className="flex items-center gap-1 sm:gap-2">
                  ...
                  <span className="hidden sm:inline">AI Architecture</span>
                  <span className="sm:hidden">AI</span>
                </TabsTrigger>
                <TabsTrigger value="optical" className="flex items-center gap-1 sm:gap-2">
                  <Eye className="h-3 w-3 sm:h-4 sm:w-4" />
                  <span className="hidden sm:inline">Optical Imaging</span>
                  <span className="sm:hidden">Optical</span>
                </TabsTrigger>
                ...
                <TabsTrigger value="deployment" className="flex items-center gap-1 sm:gap-2">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 p-6 rounded-sm">
                        <h4 className="text-sm sm:text-base font-semibold text-blue-800 mb-3">Key Innovations:</h4>
                      ...
                      <div className="bg-white rounded-sm p-6 border-2 border-gray-200">
              ...
              <TabsContent value="optical" className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-purple-50 p-6 rounded-sm">
                        <h4 className="text-sm sm:text-base font-semibold text-purple-800 mb-3">Technology Features:</h4>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-green-50 p-6 rounded-sm">
                        <h4 className="text-sm sm:text-base font-semibold text-green-800 mb-3">Validation Methods:</h4>
              ...
              <TabsContent value="deployment" className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-orange-50 p-6 rounded-sm">
                        <h4 className="text-sm sm:text-base font-semibold text-orange-800 mb-3">Performance Metrics:</h4>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-green-200 text-green-800">🎯</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-green-800">88.56% Detection Accuracy</CardTitle>
                </CardHeader>
                <CardContent>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-blue-200 text-blue-800">🐄</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-blue-800">74.47% Real-World Performance</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-purple-200 text-purple-800">📊</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-purple-800">16,000+ Annotated Images</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-amber-200 text-amber-800">🔬</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-amber-800">Multi-Method Validation</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-teal-200 text-teal-800">🐄</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-teal-800">Live Animal Testing</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-orange-200 text-orange-800">⚡</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-orange-800">Real-Time Performance</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-green-200 text-green-800">🌱</Badge>
                                      ...
                                      <CardTitle className="text-sm sm:text-base lg:text-lg text-green-800">Emission Reduction Evidence</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-sm text-gray-700 mb-3">
      ...
      <section id="journey" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">Three-Phase Research Journey</h2>
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 max-w-4xl mx-auto">
                  ...
                  <div className="w-1/2 pr-8 text-right">
                    <Card className="border-2 border-blue-200 bg-blue-50">
                      <CardHeader>
                        ...
                        <CardTitle className="text-base sm:text-lg lg:text-xl text-blue-800">Phase 1: Innovation</CardTitle>
                        <p className="text-sm sm:text-base lg:text-lg font-medium text-blue-700">Gasformer - Proving the Concept</p>
                      </CardHeader>
                      <CardContent>
                        <p className="text-sm text-gray-700 mb-3">
                        ...
                        <div className="bg-blue-100 p-3 rounded-sm">
                                            <p className="text-xs sm:text-sm text-blue-800 font-medium">Key Innovation:</p>
                  <p className="text-xs sm:text-sm text-blue-700">Transformer architecture adapted for gas plume detection</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="w-1/2 pl-8">
                    <Card className="border-2 border-green-200 bg-green-50">
                      <CardHeader>
                        ...
                        <CardTitle className="text-base sm:text-lg lg:text-xl text-green-800">Phase 2: Validation</CardTitle>
                        <p className="text-sm sm:text-base lg:text-lg font-medium text-green-700">Comprehensive Analysis - Validating the Science</p>
                      </CardHeader>
                      <CardContent>
                        <p className="text-sm text-gray-700 mb-3">
                        ...
                        <div className="bg-green-100 p-3 rounded-sm">
                                            <p className="text-xs sm:text-sm text-green-800 font-medium">Key Innovation:</p>
                  <p className="text-xs sm:text-sm text-green-700">Multi-modal validation framework with biological insights</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
                  ...
                  <div className="w-1/2 pr-8 text-right">
                    <Card className="border-2 border-purple-200 bg-purple-50">
                      <CardHeader>
                        ...
                        <CardTitle className="text-base sm:text-lg lg:text-xl text-purple-800">Phase 3: Application</CardTitle>
                        <p className="text-sm sm:text-base lg:text-lg font-medium text-purple-700">GasTwinFormer - Scaling the Solution</p>
                      </CardHeader>
                      <CardContent>
                        <p className="text-sm text-gray-700 mb-3">
                        ...
                        <div className="bg-purple-100 p-3 rounded-sm">
                                            <p className="text-xs sm:text-sm text-purple-800 font-medium">Key Innovation:</p>
                  <p className="text-xs sm:text-sm text-purple-700">Integrated detection and management decision support</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              <Card className="border-2 border-blue-200 bg-blue-50">
                <CardHeader>
                  <CardTitle className="flex items-center text-base sm:text-lg lg:text-xl text-blue-800">
                ...
                <CardContent>
                  ...
                  <div className="bg-blue-100 p-4 rounded-sm">
                    <h4 className="text-sm sm:text-base font-medium text-blue-800 mb-2">Research Impact:</h4>
              ...
              <Card className="border-2 border-green-200 bg-green-50">
                <CardHeader>
                  <CardTitle className="flex items-center text-base sm:text-lg lg:text-xl text-green-800">
                ...
                <CardContent>
                  ...
                  <div className="bg-green-100 p-4 rounded-sm">
                    <h4 className="text-sm sm:text-base font-medium text-green-800 mb-2">Farm Benefits:</h4>
              ...
              <Card className="border-2 border-purple-200 bg-purple-50">
                <CardHeader>
                  <CardTitle className="flex items-center text-base sm:text-lg lg:text-xl text-purple-800">
                ...
                <CardContent>
                  ...
                  <div className="bg-purple-100 p-4 rounded-sm">
                    <h4 className="text-sm sm:text-base font-medium text-purple-800 mb-2">Policy Support:</h4>
              ...
              <Card className="border-2 border-amber-200 bg-amber-50">
                <CardHeader>
                  <CardTitle className="flex items-center text-base sm:text-lg lg:text-xl text-amber-800">
                ...
                <CardContent>
                  ...
                  <div className="bg-amber-100 p-4 rounded-sm">
                    <h4 className="text-sm sm:text-base font-medium text-amber-800 mb-2">Environmental Impact:</h4>
            ...
            <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-blue-200">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl lg:text-2xl text-center text-gray-900">Research Support & Publications</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="text-sm sm:text-base font-medium text-blue-800 mb-1">USDA NIFA Support</h4>
                    <p className="text-sm text-gray-600">Award #2022-70001-37404</p>
                  </div>
                  <div className="text-center">
                    <FileText className="h-8 w-8 text-green-600 mx-auto mb-2" />
                    <h4 className="text-sm sm:text-base font-medium text-green-800 mb-1">Publications</h4>
            ...
            <div className="bg-white rounded-sm p-8 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-blue-800 mb-2">Multi-Gas Monitoring</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-green-800 mb-2">24/7 Surveillance</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm sm:text-base font-semibold text-purple-800 mb-2">AI Recommendations</h3>
