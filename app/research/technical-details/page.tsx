                ...
                <div className="research-phase prose prose-lg max-w-none">
                  ...
                  <div className="flex flex-wrap gap-3 mt-8">
                    <Button className="bg-blue-600 hover:bg-blue-700" asChild>
                      <a href="https://doi.org/10.1109/CVPRW63382.2024.00558" target="_blank" rel="noopener noreferrer">
                ...
                <div className="research-phase prose prose-lg max-w-none">
                  ...
                  <div className="flex flex-wrap gap-3 mt-8">
                    <Button className="bg-green-600 hover:bg-green-700" asChild>
                      <a href="https://doi.org/10.1049/ipr2.13327" target="_blank" rel="noopener noreferrer">
                        <FileText className="h-4 w-4 mr-2" />
                        Read Full Paper
                      </a>
                    </Button>
            ...
            <Card className="border-2 border-purple-200">
              ...
              <CardContent className="p-8">
                <div className="research-phase prose prose-lg max-w-none">
                  ...
                  <div className="flex flex-wrap gap-3 mt-8">
                    <Button className="bg-purple-600 hover:bg-purple-700" variant="outline" disabled>
                      <FileText className="h-4 w-4 mr-2" />
                      Paper Coming Soon
                    </Button>
                    <Button variant="outline" disabled>
