...
import { Geologica, Nunito_Sans } from "next/font/google"
import "./globals.css"
...
export const metadata: Metadata = {
  ...
  keywords: "AI, livestock, methane emissions, USDA, research, optical gas imaging, computer vision, sustainability, agricultural AI, methane detection, climate smart agriculture, greenhouse gas monitoring, livestock methane",
  authors: [
    { name: "Dr. Khaled R. Ahmed", url: "mailto:khaled.ahmed@siu.edu" },
    { name: "Dr. Amer AbuGhazaleh", url: "mailto:aabugha@siu.edu" },
    { name: "Dr. Mohamed G. Embaby", url: "mailto:membaby@ucdavis.edu" },
    { name: "Toqi Tahamid Sarker", url: "mailto:toqitahamid.sarker@siu.edu" },
    { name: "Taminul Islam", url: "mailto:taminul.islam@siu.edu" }
  ],
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${geologica.variable} ${nunitoSans.variable} min-h-screen bg-background font-sans antialiased flex flex-col`}>
        <Header />
